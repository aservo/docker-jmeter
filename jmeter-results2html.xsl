...
<!-- 
    ...
    This stylesheet transforms JMeter xml results to a Treeview like html output. The original stylesheet was taken from shanhe.me (link see below). The stylesheet was modified by the following improvements:
    - integration of subsample results including indention underneath master sample result
    - display of screenshots (provided via sampleResult.resultFile property as png)
    - prettify any JSON response data for improved readability (function / css class 'stringify_json')
    - refactored timestamp patching (and json stringifying) to happen ansynchronous upon item click rather than on page load in order to increase page load performance
    - auto-select first failed node in treeview

    original stylesheet from: http://shanhe.me/2011/06/07/new-xsl-stylesheet-for-jmeter-command-line-results-report
    procedure for xsl transformation: https://dev.pageseeder.com/get_started/tutorials/how_to_run_xslt_from_the_command_line.html
    run with e.g.: java -jar SaxonHE11-4J\saxon-he-11.4.jar -s:JMeter_Selenium_result.xml -xsl:jmeter.results.shanhe.me.xsl -o:JMeter_Selenium_result.html
-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
        ...
        <head>
            ...
            <style type="text/css"><![CDATA[
                ...
                * { margin: 0; padding: 0 }
                ...
                #left-panel div.sub-success { padding: 0 0 0 65px; background-position: 45px 3px; background-image: url(data:image/png;base64,) }
                #left-panel div.sub-failure { padding: 0 0 0 65px; background-position: 45px 3px; background-image: url(data:image/png;base64,) }
            ...
            <script type="text/javascript"><![CDATA[
                ...
                var onclick_li = (function() {
                    ...
                    return function(li) {
                        ...
                        patch_timestamps(last_selected.firstChild.nextSibling);                        
                        stringify_jsons(last_selected.firstChild.nextSibling);                        
                        document.getElementById("right-panel").innerHTML = last_selected.firstChild.nextSibling.innerHTML;
                        return false;
                    };
                })();

                var patch_timestamps = function(node) {
                    var spans = node.getElementsByTagName("span");
                    var len = spans.length;
                    for( var i = 0; i < len; ++i ) {
                        var span = spans[i];
                        if( "patch_timestamp" == span.className && !isNaN(span.innerHTML)) {
                            try {
                                span.innerHTML = new Date( parseInt( span.innerHTML ) );
                            } catch (err) {
                                //ignore errors which leaves original input in field
                            }
                        }
                    }
                };

                var stringify_jsons = function(node) {
                    var spans = node.getElementsByTagName("span");
                    var len = spans.length;
                    for( var i = 0; i < len; ++i ) {
                        var span = spans[i];
                        if( span.innerHTML && "stringify_json" == span.className ) {
                            try {
                                var json = JSON.parse(span.innerHTML);
                                span.innerHTML = JSON.stringify(json, null, 4);
                            } catch (err) {
                ...
                window.onload = function() {
                    //auto-select first failed result
                    var failed = document.getElementsByClassName("failure");
                    if (failed && failed[0].tagName !== 'TBODY') {
                        var parentLi = failed[0].parentElement;
                        onclick_li(parentLi);
                        parentLi.scrollIntoView(false);
                    } else {
                        //or select first result if no failed exist...
                ...
                <ol id="result-list">
                    <xsl:for-each select="*">
                        ...
                        <li onclick="return onclick_li(this);">
                            ...
                            <xsl:call-template name="samplerDetailsTemplate" />
                            ...
                            <xsl:for-each select="*">
                                <li onclick="return onclick_li(this);">
                                    <div>
                                        <xsl:attribute name="class">
                                            <xsl:choose>
                                                <xsl:when test="@s = 'true'">sub-success</xsl:when>
                                                <xsl:otherwise>sub-failure</xsl:otherwise>
                                            </xsl:choose>
                                        </xsl:attribute>
                                        <xsl:value-of select="@lb"/>
                                    </div>
    ...
    <xsl:template name="samplerDetailsTemplate">
        <div class="detail">
            ...
            <div class="zebra">
                <table>
                    ...
                    <tr><td class="data key">Response Data</td><td class="data delimiter">:</td><td class="data"><pre class="data"><span class="stringify_json"><xsl:value-of select="responseData"/></span></pre></td></tr>
            ...
            <div class="trail"></div>
            <xsl:if test="@rc='screenshot'">
                <div class="group">Screenshot</div>
                <img style="margin: 15px;" width="50%" height="50%">
